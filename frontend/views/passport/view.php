...
$this->params['breadcrumbs'][] = ['label' => 'Паспорта рисков процесса', 'url' => ['index?department_id='
    .$model->department_id]];
...
<div class="protocol-view">
    ...
    <p>
        ...
        <?= Html::a('<i class="fa fa-trash"></i>', ['delete', 'id' => $model->id], [
            ...
            'data' => [
                'confirm' => 'Удалить паспорт "'.$model->name.'"?',
                'method' => 'post',
            ],
        ]) ?>

        <?= Html::a('Скачать <i class="fa fa-download"></i>', ['files/passport/'.$model->department_id.'/'.$model->name, ],
            ['class' => 'btn 
        btn-warning']) ?>
    </p>
