...
$this->params['breadcrumbs'][] = ['label' => 'Документированная процедура', 'url' => ['index?department_id='
    .$model->department_id]];
...
<div class="protocol-view">
    ...
    <p>
        ...
        <?= Html::a('Скачать <i class="fa fa-download"></i>', ['files/doc/'.$model->department_id.'/'.$model->name, ],
            ['class' => 'btn 
        btn-warning']) ?>
    </p>
